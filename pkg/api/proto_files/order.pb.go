...
var file_proto_files_order_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x56, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x74,
	0x6f, 0x72, 0x65, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x42,
	0x0a, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2f, 0x73,
	...
	0x70, 0x69, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x62, 0x06,
...
var file_proto_files_order_proto_goTypes = []any{
...
func file_proto_files_order_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_files_order_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Order); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_files_order_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_proto_files_order_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_proto_files_order_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_proto_files_order_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_proto_files_order_proto_msgTypes[5].Exporter = func(v any, i int) any {
